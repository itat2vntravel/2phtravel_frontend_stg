...
import AdminLoader from "@/page-modules/AdminPages/AdminDashboard/AdminLoader";
import GetSearchResult from "@/action/booknow/bookingsearch";

const AdminDashborad = dynamic(
  () => import("@/page-modules/AdminPages/AdminDashboard/AdminDashborad"),
  {
    ssr: false,
    loading: () => (
      <>
      ...
      <div className="grid grid-cols-12">
        ...
        <div className=" xl:col-span-10 lg:col-span-9 col-span-12 ">
          <div className="bg-gray-100 ">
            <AdminDashborad bookingData={data} />
          </div>
        </div>
      </div>
    </div>
